...
SRCS=("$JAVA_DIR/SensitiveData.java" "$JAVA_DIR/LanAuth.java" "$JAVA_DIR/AssetPath.java" "$JAVA_DIR/SafeFiles.java" "$JAVA_DIR/BridgeLimits.java" "$JAVA_DIR/BackupInspector.java" "$JAVA_DIR/PluginErrorHint.java" "$JAVA_DIR/RuntimeHealth.java" "$JAVA_DIR/OfflineVersion.java" "$JAVA_DIR/OverlayLines.java" "$JAVA_DIR/UserDataPolicy.java" "$JAVA_DIR/ShellQuote.java" "$JAVA_DIR/Query.java" "$JAVA_DIR/BackupScope.java" "$JAVA_DIR/PublicDirs.java" "$JAVA_DIR/ArchiveProbe.java" "$JAVA_DIR/GitHubRef.java" "$JAVA_DIR/PluginSpec.java" "$JAVA_DIR/PatchToggle.java" "$JAVA_DIR/MarketCol.java" "$JAVA_DIR/MarketSearch.java" "$JAVA_DIR/WebProcSel.java" "$JAVA_DIR/AssetBatch.java" "$JAVA_DIR/WatchdogScript.java" "$JAVA_DIR/DangerShellGuard.java")
