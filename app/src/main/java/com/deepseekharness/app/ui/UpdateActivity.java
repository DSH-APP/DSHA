...
public final class UpdateActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle saved) {
        ...
        findViewById(R.id.update_changelog).setOnClickListener(v->CardSheet.show(this,getString(R.string.ui134_changelog),com.deepseekharness.app.util.UiText.choose("DSHA 0.1.7-rc2\n\n• 新增定时任务、快捷键和进行中会话启用新工具。\n• 修复插件详情/设置页信息缺失，以及插件安装或配置保存中断后的恢复。\n• 修复部分长对话无法继续发送，改善插件源切换和自动审阅提示。\n• 保留 DSH 0.1.7-rc.2、个人数据、插件和配置迁移路径。", "DSHA 0.1.7-rc2\n\n• Added scheduled tasks, keyboard shortcuts, and newly enabled tools for ongoing conversations.\n• Fixed missing plugin details/settings and recovery after interrupted plugin installs or settings saves.\n• Fixed some long conversations that could not send again and improved plugin-source and auto-review guidance.\n• Kept DSH 0.1.7-rc.2, personal data, plugins and configuration migration intact.")));
