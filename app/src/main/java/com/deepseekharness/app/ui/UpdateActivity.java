...
public final class UpdateActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle saved) {
        ...
        findViewById(R.id.update_changelog).setOnClickListener(v->CardSheet.show(this,getString(R.string.ui134_changelog),com.deepseekharness.app.util.UiText.choose("DSHA 0.1.7-alpha1\n\n• 修复画中画流式文字闪烁，统一数据与备份入口布局。\n• 优化 Language 弹窗首帧布局，补齐插件面板标题避让。\n• 新增 Android 11+ 独立虚拟屏，支持设备通道、预览和 AI 操作。\n• 保留 DSH 0.1.7-alpha.1、个人数据、插件和配置迁移路径。", "DSHA 0.1.7-alpha1\n\n• Fixed streaming text flicker in PiP and aligned data/backup entries.\n• Reduced first-frame work in the Language dialog and added plugin-panel clearance.\n• Added an Android 11+ independent virtual screen for device channels, preview and AI actions.\n• Kept DSH 0.1.7-alpha.1, personal data, plugins and configuration migration intact.")));
