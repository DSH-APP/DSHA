...
public final class UpdateActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle saved) {
        ...
        findViewById(R.id.update_changelog).setOnClickListener(v->CardSheet.show(this,getString(R.string.ui134_changelog),com.deepseekharness.app.util.UiText.choose("DSHA 0.1.6-alpha2\n\n• 同步 DSH alpha.2：插件管理、Office 预览、文件改动卡片与子代理侧栏。\n• 修复新版图片草稿恢复与会话导航兼容。\n• 插件查询和开关操作合并执行，后台任务可查看详情。\n• 小窗按实际尺寸重排，多行悬浮条保持稳定。\n• 使用新应用图标，保留备份、设备能力和个人数据。", "DSHA 0.1.6-alpha2\n\n• DSH alpha.2: plugin management, Office previews, file-change cards and the subagent sidebar.\n• Updated image draft recovery and session navigation.\n• Faster plugin operations and accessible background task details.\n• Adaptive mini windows and stable multiline overlays.\n• New app icon; backups, device capabilities and personal data retained.")));
