...
public final class PictureInPicturePolicy {
    ...
    public static boolean canEnter(boolean enabled, boolean supported, boolean allowed,
                                   boolean contentReady, boolean leavingForActivity, boolean finishing) {
        return enabled && supported && allowed && contentReady && !leavingForActivity && !finishing;
    }
